...
define(['ol', 'toolbar', 'layermanager', 'sidebar', 'query', 'search', 'print', 'permalink', 'measure', 'geolocation', 'api', 'hscesium', 'ows', 'datasource_selector', 'bootstrap.bundle'],
        ...
        module.value('config', {
            ...
            default_layers: [
                ...
                new ol.layer.Tile({
                    ...
                    source: new ol.source.TileWMS({
                        url: '/cgi-bin/proxy4ows.cgi?OWSURL=http%3A%2F%2Fgeoportal.vumop.cz%2Fwms_vumop%2Fzchbpej.asp',
                        params: {
                            LAYERS: 'pt',
                            FROMCRS: 'EPSG:4326',
                            owsService: 'WMS',
                ...
                new ol.layer.Tile({
                    ...
                    source: new ol.source.TileWMS({
                        url: '/cgi-bin/proxy4ows.cgi?OWSURL=http%3A%2F%2Feagri.cz%2Fpublic%2Fapp%2Fwms%2Fplpis.fcgi',
                        params: {
                ...
                new ol.layer.Tile({
                    ...
                    BoundingBox: [{
                        crs: "EPSG:4326",
                        extent: [10.3634142752449, 47.7002729482326, 19.6178942648555, 51.4135526097936]
                    }],
                    source: new ol.source.TileWMS({
